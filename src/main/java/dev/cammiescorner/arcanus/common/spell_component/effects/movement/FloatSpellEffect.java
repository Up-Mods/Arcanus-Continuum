...
public class FloatSpellEffect extends SpellEffect {
	public FloatSpellEffect() {
		super(
			...
			() -> SpellType.MOVEMENT,
			() -> ArcanusConfig.MovementEffects.FloatEffectProperties.manaCosts(),
	...
	public void effect(@Nullable LivingEntity caster, @Nullable Entity sourceEntity, Level level, HitResult target, List<SpellEffect> effects, ItemStack stack, double potency) {
		if(target.getType() == HitResult.Type.ENTITY) {
			...
			if(entityHit.getEntity() instanceof LivingEntity livingEntity)
				livingEntity.addEffect(new MobEffectInstance(ArcanusMobEffects.FLOAT.holder(), (int) (ArcanusConfig.MovementEffects.FloatEffectProperties.baseEffectDuration * potency), 0, true, false));
		}
	}
}
