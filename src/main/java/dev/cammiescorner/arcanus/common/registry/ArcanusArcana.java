...
public class ArcanusArcana {
	...
	public static final RegistrySupplier<PrimalArcana> AETHER = ARCANA.register("aether", () -> new PrimalArcana(ArcanusAttributes.AETHER_ARCANA.holder(), ArcanusAttributes.AETHER_ARCANA_REGEN.holder(), ChatFormatting.DARK_GRAY, Color.fromRGB(41, 29, 42)));
