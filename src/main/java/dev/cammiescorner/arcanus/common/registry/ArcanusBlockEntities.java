...
public class ArcanusBlockEntities {
	...
	public static final RegistrySupplier<BlockEntityType<WardedJarBlockEntity>> JAR = BLOCK_ENTITIES.register("jar", () -> BlockEntityType.Builder.of(WardedJarBlockEntity::new, ArcanusBlocks.WARDED_JAR.get()).build());
