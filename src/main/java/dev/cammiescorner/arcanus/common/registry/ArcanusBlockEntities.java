...
public class ArcanusBlockEntities {
	...
	public static final RegistrySupplier<BlockEntityType<JarBlockEntity>> JAR = BLOCK_ENTITIES.register("jar", () -> BlockEntityType.Builder.of(JarBlockEntity::new, ArcanusBlocks.JAR.get()).build());
