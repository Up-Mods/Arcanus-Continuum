...
public class ArcanusMenus {
	...
	public static final RegistrySupplier<MenuType<SpellBookMenu>> SPELL_BOOK_MENU = MENUS.register("spell_book_menu", () -> new MenuType<>((i, inventory) -> new SpellBookMenu(i, inventory, ItemStack.EMPTY), FeatureFlags.VANILLA_SET));
