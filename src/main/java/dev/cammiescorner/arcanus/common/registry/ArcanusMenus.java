...
public class ArcanusMenus {
	...
	public static final RegistrySupplier<MenuType<SpellBookMenu>> SPELL_BOOK_MENU = MENUS.register("spell_book_menu", () -> new MenuType<>((i, inventory) -> new SpellBookMenu(i, ArcanusItems.SPELL_BOOK.get().getDefaultInstance()), FeatureFlags.VANILLA_SET));
