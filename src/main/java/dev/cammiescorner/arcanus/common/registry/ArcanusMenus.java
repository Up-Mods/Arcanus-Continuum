...
public class ArcanusMenus {
	...
	public static final RegistrySupplier<MenuType<SpellcraftMenu>> SPELLCRAFT_MENU = MENUS.register("spellcraft_menu", () -> new ExtendedScreenHandlerType<>((syncId, inventory, data) -> new SpellcraftMenu(syncId, inventory), SpellcraftMenuProvider.MenuData.STREAM_CODEC));
	public static final RegistrySupplier<MenuType<ScrollOfKnowledgeMenu>> SCROLL_OF_KNOWLEDGE_MENU = MENUS.register("scroll_of_knowledge_menu", () -> new ExtendedScreenHandlerType<>((syncId, inventory, menuData) -> new ScrollOfKnowledgeMenu(syncId, menuData.stack()), ScrollOfKnowledgeMenuProvider.MenuData.STREAM_CODEC));
	...
	public static final RegistrySupplier<MenuType<BookPouchMenu>> BOOK_POUCH_MENU = MENUS.register("book_pouch_menu", () -> new ExtendedScreenHandlerType<>((syncId, inventory, menuData) -> new BookPouchMenu(syncId, inventory, menuData.pouch()), BookPouchMenuProvider.MenuData.STREAM_CODEC));
