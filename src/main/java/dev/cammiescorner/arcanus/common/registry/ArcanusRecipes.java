...
public class ArcanusRecipes {
	...
	public static final RegistrySupplier<SimpleCraftingRecipeSerializer<SpellBindingRecipe>> SPELL_BINDING = RECIPE_SERIALIZERS.register("spell_binding", () -> new SimpleCraftingRecipeSerializer<>(SpellBindingRecipe::new));
}
