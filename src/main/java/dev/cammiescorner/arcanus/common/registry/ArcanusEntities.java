...
public class ArcanusEntities {
	...
	public static final RegistrySupplier<EntityType<EntangledOrb>> ENTANGLED_ORB = ENTITY_TYPES.register("entangled_orb", () -> EntityType.Builder.of(EntangledOrb::new, MobCategory.MISC).clientTrackingRange(60).fireImmune().noSummon().sized(0.4f, 0.4f).build());
