...
public class Lob extends AbstractArrow implements Targetable {
	...
	public Lob(EntityType<? extends AbstractArrow> entityType, Level world) {
		super(entityType, world);
	}

	@Override
	public void tick() {
		if(level() instanceof ServerLevel server && (getOwner() == null || !getOwner().isAlive())) {
