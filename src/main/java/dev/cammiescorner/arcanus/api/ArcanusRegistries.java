...
public class ArcanusRegistries {
	...
	public static final ResourceKey<Registry<StaffCore>> STAFF_CORE = ResourceKey.createRegistryKey(Arcanus.id("staff_part/staff_core"));
	public static final ResourceKey<Registry<StaffCap>> STAFF_CAP = ResourceKey.createRegistryKey(Arcanus.id("staff_part/staff_cap"));
}
