...
public abstract class DamageModifyingSpellEffect extends SpellEffect {
	public DamageModifyingSpellEffect(Supplier<Boolean> isEnabled, Supplier<SpellType> type, Supplier<Map<PrimalArcana, Double>> arcanaCost, Supplier<Boolean> procsOnce) {
