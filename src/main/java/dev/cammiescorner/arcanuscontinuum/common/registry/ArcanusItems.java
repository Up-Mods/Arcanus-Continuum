...
public class ArcanusItems {
	...
	public static final Item WIZARD_SPAWN_EGG = create("wizard_spawn_egg", new SpawnEggItem(ArcanusEntities.WIZARD, 0x52392a, 0xffd87c, new QuiltItemSettings().group(Arcanus.ITEM_GROUP)));
