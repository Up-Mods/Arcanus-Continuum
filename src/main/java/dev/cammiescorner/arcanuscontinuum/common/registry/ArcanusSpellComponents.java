...
public class ArcanusSpellComponents {
	...
	public static final SpellShape BEAM = beamShapeProperties.enabled ? create("beam_shape", new DelaySpellShape(beamShapeProperties.weight, beamShapeProperties.manaCost, beamShapeProperties.manaMultiplier, beamShapeProperties.coolDown, beamShapeProperties.minimumLevel)) : null;
