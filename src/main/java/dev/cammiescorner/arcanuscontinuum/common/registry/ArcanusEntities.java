...
public class ArcanusEntities {
	...
	public static final RegistrySupplier<EntityType<GuidedShot>> GUIDED_SHOT = ENTITY_TYPES.register("guided_shot", () -> FabricEntityTypeBuilder.create().entityFactory(GuidedShot::new).fireImmune().disableSummon().dimensions(EntityDimensions.fixed(0.6f, 0.6f)).build());
