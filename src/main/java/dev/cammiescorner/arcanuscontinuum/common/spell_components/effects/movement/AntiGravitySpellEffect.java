...
public class AntiGravitySpellEffect extends SpellEffect {
	public AntiGravitySpellEffect(boolean isEnabled, SpellType type, Weight weight, double manaCost, int coolDown, int minLevel) {
