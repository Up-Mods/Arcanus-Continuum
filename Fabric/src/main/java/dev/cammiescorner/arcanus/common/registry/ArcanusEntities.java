...
public class ArcanusEntities {
	...
	public static final RegistrySupplier<EntityType<MagicOrb>> MAGIC_ORB = ENTITY_TYPES.register("magic_orb", () -> EntityType.Builder.of(MagicOrb::new, MobCategory.MISC).clientTrackingRange(60).fireImmune().noSummon().sized(0.4f, 0.4f).build());
	public static final RegistrySupplier<EntityType<StockpileOrb>> STOCKPILE_ORB = ENTITY_TYPES.register("stockpile_orb", () -> EntityType.Builder.of(StockpileOrb::new, MobCategory.MISC).clientTrackingRange(60).fireImmune().noSummon().sized(0.4f, 0.4f).build());
