...
// TODO rework spells once they are implemented again
public record ArcanusChestLoot(HolderLookup.Provider registries) implements LootTableSubProvider {

	@Override
	public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
		output.accept(ArcanusLootTables.WIZARD_TOWER_CHEST, LootTable.lootTable()
			.withPool(LootPool.lootPool()
				.setRolls(ConstantValue.exactly(1f))
				.add(NestedLootTable.lootTableReference(BuiltInLootTables.IGLOO_CHEST))));
...
//						.apply(setSpellNbt(ArcanusChestLoot::healSelfSpell))
//						.when(LootItemRandomChanceCondition.randomChance(0.25f)),
//					LootItem.lootTableItem(ArcanusItems.SPELL_BOOK.get())
//						.apply(setSpellNbt(ArcanusChestLoot::healAllySpell))
//						.when(LootItemRandomChanceCondition.randomChance(0.25f)),
//					LootItem.lootTableItem(ArcanusItems.SPELL_BOOK.get())
//						.apply(setSpellNbt(ArcanusChestLoot::paladinsShieldSpell))
//						.when(LootItemRandomChanceCondition.randomChance(0.25f)),
//					LootItem.lootTableItem(ArcanusItems.SPELL_BOOK.get())
//						.apply(setSpellNbt(ArcanusChestLoot::fireballSpell))
//						.when(LootItemRandomChanceCondition.randomChance(0.25f)),
//					LootItem.lootTableItem(ArcanusItems.SPELL_BOOK.get())
//						.apply(setSpellNbt(ArcanusChestLoot::magicMissileSpell))
//						.when(LootItemRandomChanceCondition.randomChance(0.25f)),
//					LootItem.lootTableItem(ArcanusItems.SPELL_BOOK.get())
//						.apply(setSpellNbt(ArcanusChestLoot::smiteSpell))
//						.when(LootItemRandomChanceCondition.randomChance(0.25f)),
//					LootItem.lootTableItem(ArcanusItems.SPELL_BOOK.get())
//						.apply(setSpellNbt(ArcanusChestLoot::blinkSpell))
//						.when(LootItemRandomChanceCondition.randomChance(0.25f)),
//					LootItem.lootTableItem(ArcanusItems.SPELL_BOOK.get())
//						.apply(setSpellNbt(ArcanusChestLoot::zoomiesSpell))
//						.when(LootItemRandomChanceCondition.randomChance(0.25f))
//				))
				.add(LootItem.lootTableItem(Items.WRITABLE_BOOK).setWeight(5))
				.add(LootItem.lootTableItem(Items.BOOK).setWeight(5))
				.add(LootItem.lootTableItem(Items.BOOK).setWeight(3).apply(EnchantWithLevelsFunction.enchantWithLevels(registries, UniformGenerator.between(1, 3))))
				.add(LootItem.lootTableItem(Items.BOOK).setWeight(2).apply(EnchantWithLevelsFunction.enchantWithLevels(registries, UniformGenerator.between(11, 20))))
				.add(LootItem.lootTableItem(Items.BOOK).setWeight(1).apply(EnchantWithLevelsFunction.enchantWithLevels(registries, UniformGenerator.between(21, 30))))
			)
		);
	}
