...
public class ArcanusEnglishLanguageProvider extends SparkweaveLanguageProvider {
	...
	public void generateTranslations(HolderLookup.Provider registerLookup, TranslationBuilder builder) {
		...
		builder.item(ArcanusItems.ALCHEMIST_GOGGLES, "Alchemist Goggles");
		builder.item(ArcanusItems.ALCHEMIST_ROBES, "Alchemist Robes");
		builder.item(ArcanusItems.ALCHEMIST_PANTS, "Alchemist Pants");
		builder.item(ArcanusItems.ALCHEMIST_BOOTS, "Alchemist Boots");
		builder.item(ArcanusItems.CULTIST_CLERIC_HOOD, "Cultist Cleric Hood");
		builder.item(ArcanusItems.CULTIST_CLERIC_ROBES, "Cultist Cleric Robes");
		builder.item(ArcanusItems.CULTIST_CLERIC_PANTS, "Cultist Cleric Pants");
		builder.item(ArcanusItems.CULTIST_CLERIC_BOOTS, "Cultist Cleric Boots");
		builder.item(ArcanusItems.CULTIST_KNIGHT_HELMET, "Cultist Knight Helmet");
		builder.item(ArcanusItems.CULTIST_KNIGHT_CHESTPLATE, "Cultist Knight Chestplate");
		builder.item(ArcanusItems.CULTIST_KNIGHT_LEGGINGS, "Cultist Knight Leggings");
		builder.item(ArcanusItems.CULTIST_KNIGHT_BOOTS, "Cultist Knight Boots");
		...
		builder.item(ArcanusItems.EBONY_STAFF_CORE, "Ebony Staff Core");
		...
		builder.block(ArcanusBlocks.CRUCIBLE, "Crucible");
		builder.block(ArcanusBlocks.ATHANOR, "Athanor");
		builder.block(ArcanusBlocks.ALEMBIC, "Alembic");
		builder.block(ArcanusBlocks.CENTRIFUGE, "Centrifuge");
		builder.block(ArcanusBlocks.VORTEXER, "Vortexer");
		builder.block(ArcanusBlocks.ARCANA_PIPE, "Arcana Pipe");
		builder.block(ArcanusBlocks.ARCANA_PUMP, "Arcana Pump");
		builder.block(ArcanusBlocks.WARDED_JAR, "Warded Jar");
		builder.block(ArcanusBlocks.MANA_BEAN, "Mana Bean");
