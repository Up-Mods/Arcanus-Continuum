...
import dev.cammiescorner.arcanus.spell_component.effects.attack.*;
import dev.cammiescorner.arcanus.spell_component.effects.movement.*;
import dev.cammiescorner.arcanus.spell_component.effects.support.*;
import dev.cammiescorner.arcanus.spell_component.effects.utility.*;
import dev.cammiescorner.arcanus.spell_component.shapes.*;
