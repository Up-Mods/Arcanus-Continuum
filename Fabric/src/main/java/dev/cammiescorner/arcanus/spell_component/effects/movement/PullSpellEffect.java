...
public class PullSpellEffect extends SpellEffect {
	public PullSpellEffect() {
		super(
			...
			() -> ArcanusConfig.MovementEffects.PullEffectProperties.activatesOnce
		);
	}
	...
	public void effect(@Nullable LivingEntity caster, @Nullable Entity sourceEntity, Level level, HitResult target, List<SpellEffect> effects, ItemStack stack, double potency) {
		if(target.getType() == HitResult.Type.ENTITY) {
			...
			double amount = -ArcanusConfig.MovementEffects.PullEffectProperties.basePullStrength * potency;
