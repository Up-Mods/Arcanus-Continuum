...
import dev.cammiescorner.arcanus.entity.magic.Beam;
...
public class BeamSpellShape extends SpellShape {
	public BeamSpellShape() {
		super(
			...
			() -> ArcanusConfig.SpellShapes.BeamShapeProperties.arcanaCosts(),
			() -> ArcanusConfig.SpellShapes.BeamShapeProperties.arcanaModifier,
			...
			() -> ArcanusConfig.SpellShapes.BeamShapeProperties.activatesOnce);
	}
